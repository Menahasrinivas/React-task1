...
function Card({data}) {
  ...
  <div className="data mb-5 mb-lg-0">
    <div className="data-body">
      <h5 className="data-title text-muted text-uppercase text-center">{data.plan}</h5>
      <h6 className="data-price text-center">${data.price}<span className="period">/month</span></h6>
      <hr/>
      <ul className="fa-ul">
